...
// Copyright (c) 2009-present The Aureus Core developers
...
{
    const char* pszTimestamp = "Aureus 06/Feb/2026: The New Golden Standard for Financial Decentralization";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256{"00000709e30d30e9d5024bad04a2572a586aa501cf7d83b332acc1aaae4feff7"};
        ...
        consensus.nMinimumChainWork = uint256{"000000000000000000000000000000000000000000000022522d534d1633529e"}; // 42586
        consensus.defaultAssumeValid = uint256{"0000000000000000a85e446073d735fb2b69faba5702cc49b95637623a73a607"}; // 42586
        ...
        genesis = CreateGenesisBlock(1738848000, 2677042, 0x1e0ffff0, 1, 10000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000709e30d30e9d5024bad04a2572a586aa501cf7d83b332acc1aaae4feff7"});
        assert(genesis.hashMerkleRoot == uint256{"71ea6267a1efcbb831d0b33f66e70e75d8aa37e136322d281ab883f339f17830"});
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128+23);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1738848001, 170751, 0x1e0ffff0, 1, 10000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
       // assert(consensus.hashGenesisBlock == uint256{"000001258d4756b066a5f914a55a6899439833c91254d562562728e7d8de938d"});
       // assert(genesis.hashMerkleRoot == uint256{"c633ad5b73b3959e5acb581b305b8290231f2a1b0a096dbf16638fc192c7afea"});
        ...
        m_headers_sync_params = HeadersSyncParams{
            .commitment_period = 2016,
            .redownload_buffer_size = 4032, // 13460/628 = ~21.4 commitments
        };
    }
};
...
public:
    CTestNet4Params() {
        ...
        const char* testnet4_genesis_msg = "Aureus Testnet4 Launch - Feb 2026";
       ...
       // assert(genesis.hashMerkleRoot == uint256{"c633ad5b73b3959e5acb581b305b8290231f2a1b0a096dbf16638fc192c7afea"});
        ...
        m_headers_sync_params = HeadersSyncParams{
            .commitment_period = 632,
            .redownload_buffer_size = 15000, // 7017/275 = ~25.5 commitments
        };
    }
};
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        genesis = CreateGenesisBlock(1738848000, 52613770, 0x1e0377ae, 1, 10000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
       ...
       // assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
        ...
        m_headers_sync_params = HeadersSyncParams{
            .commitment_period = 632,
            .redownload_buffer_size = 15000, // 9584/390 = ~24.6 commitments
        };
    }
};
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1738848000, 2, 0x207fffff, 1, 10000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
       ...
       // assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
        ...
        chainTxData = ChainTxData{
            .nTime = 1738848000,
            .tx_count = 0,
            .dTxRate = 0.0, // Set a non-zero rate to make it testable
        };
